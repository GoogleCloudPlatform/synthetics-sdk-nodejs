...
export function setDefaultOptions(
  ...
  if (outputOptions.screenshot_options?.storage_location) {
    outputOptions.screenshot_options.storage_location = inputOptions.screenshot_options!.storage_location!;
  } else {
    outputOptions.screenshot_options.storage_location = defaultOptions.screenshot_options!.storage_location!;
  }
